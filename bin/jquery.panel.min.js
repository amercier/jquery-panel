...
var wrapper=$this.wrap("<div></div>").parent().addClass("panel");wrapper.css({top:top,bottom:bottom,left:left,right:right,height:top=="auto"||bottom=="auto"?outerHeight:"auto",width:left=="auto"||right=="auto"?outerWidth:"auto",margin:[this.style.marginTop,this.style.marginRight,this.style.marginBottom,this.style.marginLeft].join(" ")||"auto",position:$this.css("position")||"absolute"});
