...
if(!data||!data._init){var allOptions=$.extend({_init:true},defaultOptions,data||{},options),outerWidth=$this.outerWidth(),outerHeight=$this.outerHeight(),width=$this.width(),height=$this.height(),position=$this.position(),cssPosition=$this.css("position"),top=$this.css("top")||"auto",bottom=$this.css("bottom")||"auto",left=$this.css("left")||"auto",right=$this.css("right")||"auto";
