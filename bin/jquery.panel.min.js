...
var wrapper=$this.wrap("<div></div>").parent().addClass("panel");wrapper.css({top:$this.css("top")||"auto",bottom:$this.css("bottom")||"auto",left:$this.css("left")||"auto",right:$this.css("right")||"auto",height:outerHeight,width:outerWidth,margin:[this.style.marginTop,this.style.marginRight,this.style.marginBottom,this.style.marginLeft].join(" ")||"auto",position:$this.css("position")||"absolute"});
